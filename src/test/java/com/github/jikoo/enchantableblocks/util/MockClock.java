...
/**
 * A Clock implementation that reports fake times based on an internally stored number. Fake times
 * are in milliseconds.
 */
public class MockClock extends Clock {
  ...
  /**
   * Add an amount of time to the fake clock. Note that times are internally stored in milliseconds,
   * so more granular additions may be lost.
   *
